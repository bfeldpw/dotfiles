...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn.with_shell("dm-tool switch-to-greeter && sleep 5 && systemctl -i suspend") end,
              {description = "suspend, switch to login manager first", group = "awesome"}),
    -- awful.key({ modkey, "Shift"   }, "q", awesome.quit,
    awful.key({ modkey, "Shift"   }, "q", function () confirmation_menu_quit:show() end,
...
awful.rules.rules = {
    ...
    { rule = { class = "Element" },
      properties = { tag = " 7 ", switchtotag = false }
    },
    { rule = { class = "Evolution" },
      properties = { tag = " 7 ", switchtotag = false }
    },
    { rule = { class = "Pavucontrol" },
      properties = { tag = " 9 ", switchtotag = false }
    },
    ...
    -- Rules for tag 1 (dev) to spawn EMacs as master window
    -- Additionally, terminal (Alacritty) should always be spawned
    -- in slave mode
    {
      rule = { class = "Emacs" },
    ...
    },
    {
      ...
      callback = function(c)
          if awful.tag.selected(1).index == 1 then
...
awful.spawn.with_shell("xmodmap ~/.swapcapsesc")
-- }}}
